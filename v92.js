/* Lousa de Estudos v92 — textos completos de Geografia + runtime estável */
(()=>{
  if(window.__lousaV92Stable)return;
  window.__lousaV92Stable=true;
  const VERSION=92, SEP='§';
  ...
  const GEO_TEXTS={
    cidades:{
      ...
      passage:`<div class="v92StudyLead"><strong>📚 Como estudar:</strong> leia este texto antes das questões. As informações necessárias para responder estão explicadas aqui.</div>
    ...
    desigualdade:{
      ...
      passage:`<div class="v92StudyLead"><strong>📚 Como estudar:</strong> todas as ideias usadas nas questões estão reunidas neste texto.</div>
    ...
    diversidade:{
      ...
      passage:`<div class="v92StudyLead"><strong>📚 Como estudar:</strong> use este texto para revisar a formação cultural brasileira e as desigualdades estudadas no livro.</div>
    ...
    saopaulo:{
      ...
      passage:`<div class="v92StudyLead"><strong>📚 Como estudar:</strong> o texto explica os conceitos e os exemplos culturais usados nas perguntas.</div>
    ...
    jornal:{
      ...
      passage:`<div class="v92StudyLead"><strong>📚 Como estudar:</strong> observe os números e também o que eles significam para a vida das pessoas.</div>
    ...
    tecnologia:{
      ...
      passage:`<div class="v92StudyLead"><strong>📚 Como estudar:</strong> este texto reúne os conceitos necessários para responder às questões sobre tecnologia e trabalho.</div>
  ...
  function patchUnlock(){
    try{
      if(typeof isLessonUnlocked==='function'&&!isLessonUnlocked.__v92Religion){
        ...
        wrapped.__v92Religion=true; isLessonUnlocked=wrapped;
      }
    }catch(e){}
  }
  ...
  function patchTheme(){
    try{
      if(typeof applySubjectTheme==='function'&&!applySubjectTheme.__v92Religion){
  ...
  function refresh(){
    installReligion(); installGeographyTexts(); patchUnlock(); patchTheme(); styles(); stamp();
  ...
  setTimeout(()=>{refresh();document.getElementById('v92VersionBootHide')?.remove()},1200);
  window.__lousaV92Ready=true;
})();
