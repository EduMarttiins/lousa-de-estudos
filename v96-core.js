/* Lousa de Estudos v96 — textos completos de Geografia + runtime estável */
(()=>{
  if(window.__lousaV96Stable)return;
  window.__lousaV96Stable=true;
  const VERSION=96, SEP='§';
  ...
  const GEO_TEXTS={
    cidades:{
      ...
      passage:`<div class="v96StudyLead"><strong>📚 Como estudar:</strong> leia este texto antes das questões. As informações necessárias para responder estão explicadas aqui.</div>
    ...
    desigualdade:{
      ...
      passage:`<div class="v96StudyLead"><strong>📚 Como estudar:</strong> todas as ideias usadas nas questões estão reunidas neste texto.</div>
    ...
    diversidade:{
      ...
      passage:`<div class="v96StudyLead"><strong>📚 Como estudar:</strong> use este texto para revisar a formação cultural brasileira e as desigualdades estudadas no livro.</div>
    ...
    saopaulo:{
      ...
      passage:`<div class="v96StudyLead"><strong>📚 Como estudar:</strong> o texto explica os conceitos e os exemplos culturais usados nas perguntas.</div>
    ...
    jornal:{
      ...
      passage:`<div class="v96StudyLead"><strong>📚 Como estudar:</strong> observe os números e também o que eles significam para a vida das pessoas.</div>
    ...
    tecnologia:{
      ...
      passage:`<div class="v96StudyLead"><strong>📚 Como estudar:</strong> este texto reúne os conceitos necessários para responder às questões sobre tecnologia e trabalho.</div>
  ...
  function patchUnlock(){
    try{
      if(typeof isLessonUnlocked==='function'&&!isLessonUnlocked.__v96Religion){
        ...
        wrapped.__v96Religion=true; isLessonUnlocked=wrapped;
      }
    }catch(e){}
  }
  ...
  function patchTheme(){
    try{
      if(typeof applySubjectTheme==='function'&&!applySubjectTheme.__v96Religion){
  ...
  function applyGradeData(){
    try{
      ...
      const source=selectedGrade==='7'?window.__v96Math7Subject:math5Snapshot;
  ...
  function syncGradeHero(){
    try{
      ...
      document.querySelectorAll('#v96GradePicker .v96GradeBtn').forEach(btn=>{
  ...
  function ensureGradePicker(){
    try{
      ...
      if(!view||!grid)return;
      let host=document.getElementById('v96GradePicker');
      if(!host){
        host=document.createElement('div');
        host.id='v96GradePicker';
        host.className='v96GradePicker';
        host.innerHTML='<div class="v96GradeTitle"><strong>Qual ano vamos revisar?</strong><span>Escolha o ano escolar antes da matéria.</span></div><div class="v96GradeActions"><button type="button" class="v96GradeBtn" data-grade="5">5º ano</button><button type="button" class="v96GradeBtn" data-grade="7">7º ano</button></div>';
        grid.parentNode.insertBefore(host,grid);
        host.querySelectorAll('.v96GradeBtn').forEach(btn=>btn.addEventListener('click',()=>{
  ...
  function gradeStyles(){
    if(document.getElementById('v96GradeStyles'))return;
    const s=document.createElement('style');s.id='v96GradeStyles';
    s.textContent='.v96GradePicker{display:flex;align-items:center;justify-content:space-between;gap:16px;margin:18px 0 24px;padding:16px 18px;border:1px solid var(--lineSoft,#e5e7eb);border-radius:20px;background:#fff;box-shadow:0 8px 24px rgba(15,23,42,.05)}.v96GradeTitle{display:flex;flex-direction:column;gap:4px}.v96GradeTitle strong{font-size:1rem}.v96GradeTitle span{font-size:.86rem;color:#64748b}.v96GradeActions{display:flex;gap:8px;flex-wrap:wrap}.v96GradeBtn{appearance:none;border:1px solid #cbd5e1;background:#fff;color:#334155;border-radius:999px;padding:10px 16px;font-weight:800;font-size:.95rem;cursor:pointer}.v96GradeBtn.active{background:#1d4ed8;color:#fff;border-color:#1d4ed8;box-shadow:0 7px 16px rgba(29,78,216,.18)}@media(max-width:640px){.v96GradePicker{align-items:flex-start;flex-direction:column}.v96GradeActions{width:100%}.v96GradeBtn{flex:1}}';
    s.textContent+=' .v96Math7Question .v41MathSteps{display:none!important}.v96Math7Question .v50AnswerBox{display:none!important}.v96Math7Question .options{display:grid!important}.v96Math7Question .scratchCard{display:block!important}.v96Math7Question .scratchBoard,.v96Math7Question .scratchBoard .canvasWrap{background:#fff!important;background-image:none!important}.v96Math7Instruction{display:grid;gap:7px;margin:12px 0 14px;padding:14px 16px;border:1px solid #bfdbfe;border-radius:16px;background:#eff6ff;color:#334155;font-size:13px;line-height:1.45}.v96Math7Instruction strong{color:#1d4ed8;font-size:14px}.v96Math7Instruction span{display:block}.v96Math7Instruction em{font-style:normal;font-weight:900;color:#1d4ed8}';
    document.head.appendChild(s);
  }
  ...
  function installGradeSystem(){
    try{
      ...
      if(typeof renderSubjectCards==='function'&&!renderSubjectCards.__v96Grade){
        ...
        wrapped.__v96Grade=true;renderSubjectCards=wrapped;
      }

      if(typeof applySubjectTheme==='function'&&!applySubjectTheme.__v96Grade){
        const previous=applySubjectTheme;
        ...
        wrapped.__v96Grade=true;applySubjectTheme=wrapped;
      }

      if(typeof resetTheme==='function'&&!resetTheme.__v96Grade){
        ...
        wrapped.__v96Grade=true;resetTheme=wrapped;
      }

      if(typeof updateProgress==='function'&&!updateProgress.__v96Grade){
        ...
        wrapped.__v96Grade=true;updateProgress=wrapped;
      }
  ...
  function installMath7QuestionUI(){
    try{
      if(typeof shouldShowScratchpad==='function'&&!shouldShowScratchpad.__v96Math7){
        const previous=shouldShowScratchpad;
        const wrapped=function(q){
          if(String(q&&q.id||'').startsWith('m7_'))return true;
          return previous.apply(this,arguments);
        };
        wrapped.__v96Math7=true;
        shouldShowScratchpad=wrapped;
      }

      if(typeof buildQuestion==='function'&&!buildQuestion.__v96Math7){
        ...
        const wrapped=function(q,num){
          ...
          card.classList.add('v96Math7Question');
          ...
          if(!card.querySelector('.v96Math7Instruction')){
            const note=document.createElement('div');
            note.className='v96Math7Instruction';
    ...
    }catch(e){console.warn('v96: interface do 7º ano',e)}
  }
  ...
  setTimeout(()=>{refresh();document.getElementById('v96VersionBootHide')?.remove()},1200);
  window.__lousaV96Ready=true;
})();
