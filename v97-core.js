/* Lousa de Estudos v97 — textos completos de Geografia + runtime estável */
(()=>{
  if(window.__lousaV97Stable)return;
  window.__lousaV97Stable=true;
  const VERSION=97, SEP='§';
  ...
  const GEO_TEXTS={
    cidades:{
      ...
      passage:`<div class="v97StudyLead"><strong>📚 Como estudar:</strong> leia este texto antes das questões. As informações necessárias para responder estão explicadas aqui.</div>
    ...
    desigualdade:{
      ...
      passage:`<div class="v97StudyLead"><strong>📚 Como estudar:</strong> todas as ideias usadas nas questões estão reunidas neste texto.</div>
    ...
    diversidade:{
      ...
      passage:`<div class="v97StudyLead"><strong>📚 Como estudar:</strong> use este texto para revisar a formação cultural brasileira e as desigualdades estudadas no livro.</div>
    ...
    saopaulo:{
      ...
      passage:`<div class="v97StudyLead"><strong>📚 Como estudar:</strong> o texto explica os conceitos e os exemplos culturais usados nas perguntas.</div>
    ...
    jornal:{
      ...
      passage:`<div class="v97StudyLead"><strong>📚 Como estudar:</strong> observe os números e também o que eles significam para a vida das pessoas.</div>
    ...
    tecnologia:{
      ...
      passage:`<div class="v97StudyLead"><strong>📚 Como estudar:</strong> este texto reúne os conceitos necessários para responder às questões sobre tecnologia e trabalho.</div>
  ...
  function patchUnlock(){
    try{
      if(typeof isLessonUnlocked==='function'&&!isLessonUnlocked.__v97Religion){
        ...
        wrapped.__v97Religion=true; isLessonUnlocked=wrapped;
      }
    }catch(e){}
  }
  ...
  function patchTheme(){
    try{
      if(typeof applySubjectTheme==='function'&&!applySubjectTheme.__v97Religion){
  ...
  function applyGradeData(){
    try{
      ...
      const source=selectedGrade==='7'?window.__v97Math7Subject:math5Snapshot;
  ...
  function syncGradeHero(){
    try{
      ...
      document.querySelectorAll('#v97GradePicker .v97GradeBtn').forEach(btn=>{
  ...
  function ensureGradePicker(){
    try{
      ...
      if(!view||!grid)return;
      let host=document.getElementById('v97GradePicker');
      if(!host){
        host=document.createElement('div');
        host.id='v97GradePicker';
        host.className='v97GradePicker';
        host.innerHTML='<div class="v97GradeTitle"><strong>Qual ano vamos revisar?</strong><span>Escolha o ano escolar antes da matéria.</span></div><div class="v97GradeActions"><button type="button" class="v97GradeBtn" data-grade="5">5º ano</button><button type="button" class="v97GradeBtn" data-grade="7">7º ano</button></div>';
        grid.parentNode.insertBefore(host,grid);
        host.querySelectorAll('.v97GradeBtn').forEach(btn=>btn.addEventListener('click',()=>{
  ...
  function gradeStyles(){
    if(document.getElementById('v97GradeStyles'))return;
    const s=document.createElement('style');s.id='v97GradeStyles';
    s.textContent='.v97GradePicker{display:flex;align-items:center;justify-content:space-between;gap:16px;margin:18px 0 24px;padding:16px 18px;border:1px solid var(--lineSoft,#e5e7eb);border-radius:20px;background:#fff;box-shadow:0 8px 24px rgba(15,23,42,.05)}.v97GradeTitle{display:flex;flex-direction:column;gap:4px}.v97GradeTitle strong{font-size:1rem}.v97GradeTitle span{font-size:.86rem;color:#64748b}.v97GradeActions{display:flex;gap:8px;flex-wrap:wrap}.v97GradeBtn{appearance:none;border:1px solid #cbd5e1;background:#fff;color:#334155;border-radius:999px;padding:10px 16px;font-weight:800;font-size:.95rem;cursor:pointer}.v97GradeBtn.active{background:#1d4ed8;color:#fff;border-color:#1d4ed8;box-shadow:0 7px 16px rgba(29,78,216,.18)}@media(max-width:640px){.v97GradePicker{align-items:flex-start;flex-direction:column}.v97GradeActions{width:100%}.v97GradeBtn{flex:1}}';
    s.textContent+=' .v97Math7Question .v41MathSteps{display:none!important}.v97Math7Question .v50AnswerBox{display:none!important}.v97Math7Question .options{display:grid!important}.v97Math7Question .scratchCard{display:block!important}.v97Math7Question .scratchBoard,.v97Math7Question .scratchBoard .canvasWrap{background:#fff!important;background-image:none!important}.v97Math7Instruction{display:grid;gap:7px;margin:12px 0 14px;padding:14px 16px;border:1px solid #bfdbfe;border-radius:16px;background:#eff6ff;color:#334155;font-size:13px;line-height:1.45}.v97Math7Instruction strong{color:#1d4ed8;font-size:14px}.v97Math7Instruction span{display:block}.v97Math7Instruction em{font-style:normal;font-weight:900;color:#1d4ed8}';
    document.head.appendChild(s);
  }
  ...
  function installGradeSystem(){
    try{
      ...
      if(typeof renderSubjectCards==='function'&&!renderSubjectCards.__v97Grade){
        ...
        wrapped.__v97Grade=true;renderSubjectCards=wrapped;
      }

      if(typeof applySubjectTheme==='function'&&!applySubjectTheme.__v97Grade){
        const previous=applySubjectTheme;
        ...
        wrapped.__v97Grade=true;applySubjectTheme=wrapped;
      }

      if(typeof resetTheme==='function'&&!resetTheme.__v97Grade){
        ...
        wrapped.__v97Grade=true;resetTheme=wrapped;
      }

      if(typeof updateProgress==='function'&&!updateProgress.__v97Grade){
        ...
        wrapped.__v97Grade=true;updateProgress=wrapped;
      }
  ...
  function installMath7QuestionUI(){
    try{
      if(typeof shouldShowScratchpad==='function'&&!shouldShowScratchpad.__v97Math7){
        const previous=shouldShowScratchpad;
        const wrapped=function(q){
          if(String(q&&q.id||'').startsWith('m7_'))return true;
          return previous.apply(this,arguments);
        };
        wrapped.__v97Math7=true;
        shouldShowScratchpad=wrapped;
      }

      if(typeof buildQuestion==='function'&&!buildQuestion.__v97Math7){
        ...
        const wrapped=function(q,num){
          ...
          card.classList.add('v97Math7Question');
          ...
          if(!card.querySelector('.v97Math7Instruction')){
            const note=document.createElement('div');
            note.className='v97Math7Instruction';
    ...
    }catch(e){console.warn('v97: interface do 7º ano',e)}
  }
  ...
  setTimeout(()=>{refresh();document.getElementById('v97VersionBootHide')?.remove()},1200);
  window.__lousaV97Ready=true;
})();
